...
6. Download `Woodenstatuettes.zip` from the [releases page](https://github.com/ds5678/Woodenstatuettes/releases)
7. Move `Woodenstatuettes.zip` into the `ModComponentZips` folder within your mods folder. Do not extract it!
